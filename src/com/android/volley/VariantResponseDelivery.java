...
public class VariantResponseDelivery implements ResponseDelivery {
   ...
   */
  public VariantResponseDelivery(final Handler handler) {
   ...
   */
  public VariantResponseDelivery(Executor executor) {
